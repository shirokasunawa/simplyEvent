...
<html lang="fr">
    <body onload="testConnexion()">
        ...
        <div class="d-flex justify-content-center">
            ...
            <button type="button" class="btn btn-primary" style="width: 18rem;margin: 1.5rem 1.5rem;height:10rem;background-color:#e685b5 ;  border-color:#e685b5;" onclick="abonnement()">Abonnement</button>
        </div>
    </body>
</html>